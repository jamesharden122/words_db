...
pub struct DefComp {
    ...
    pub contrib_co: Option<f64>,
    pub contrib_exec: Option<f64>,
    pub cusip: Option<String>,
    pub defer_balance: Option<f64>,
    pub defer_earnings: Option<f64>,
    pub defer_id: Option<f64>,
    pub defer_rpt_as_comp: Option<f64>,
    pub defer_withdr: Option<f64>,
...
impl ToPolars for DefComp {
    fn schema() -> Schema {
        DefComp::polars_schema()
    }
}

impl DuckCrudModel for DefComp {
    fn table() -> &'static str {
        "deferredcomp"
    }
}
...
impl DefComp {
    pub fn polars_schema() -> Schema {
        Schema::from_iter(vec![
            ...
            Field::new("contrib_co".into(), DataType::Float64),
            Field::new("contrib_exec".into(), DataType::Float64),
            Field::new("cusip".into(), DataType::String),
            Field::new("defer_balance".into(), DataType::Float64),
            Field::new("defer_earnings".into(), DataType::Float64),
            Field::new("defer_id".into(), DataType::Float64),
            Field::new("defer_rpt_as_comp".into(), DataType::Float64),
            Field::new("defer_withdr".into(), DataType::Float64),
    ...
    pub async fn read_range<'a>(
        ...
        Err(std::io::Error::new(
            ...
            "DefComp::read_range not implemented; prefer DefComp::read_range_to_parquet + Polars scan",
        )
        .into())
    }
}
