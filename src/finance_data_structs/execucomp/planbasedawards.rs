...
pub struct PlanBaseAwrd {
    ...
    pub eq_max: Option<f64>,
    pub eq_targ: Option<f64>,
    pub eq_thres: Option<f64>,
    ...
    pub non_eq_max: Option<f64>,
    pub non_eq_targ: Option<f64>,
    pub non_eq_thres: Option<f64>,
    pub opts_grt: Option<f64>,
    pub page: Option<f64>,
...
impl ToPolars for PlanBaseAwrd {
    fn schema() -> Schema {
        PlanBaseAwrd::polars_schema()
    }
}

impl DuckCrudModel for PlanBaseAwrd {
    fn table() -> &'static str {
        "planbasedawards"
    }
}
...
impl PlanBaseAwrd {
    pub fn polars_schema() -> Schema {
        Schema::from_iter(vec![
            Field::new("act_date".into(), DataType::Date),
            ...
            Field::new("eq_max".into(), DataType::Float64),
            Field::new("eq_targ".into(), DataType::Float64),
            Field::new("eq_thres".into(), DataType::Float64),
            ...
            Field::new("fair_value".into(), DataType::Float64),
            Field::new("gender".into(), DataType::String),
            Field::new("grant_date".into(), DataType::Date),
            ...
            Field::new("non_eq_max".into(), DataType::Float64),
            Field::new("non_eq_targ".into(), DataType::Float64),
            Field::new("non_eq_thres".into(), DataType::Float64),
            Field::new("opts_grt".into(), DataType::Float64),
            ...
            Field::new("shares_grt".into(), DataType::Float64),
    ...
    pub async fn read_range<'a>(
        ...
        Err(std::io::Error::new(
            ...
            "PlanBaseAwrd::read_range not implemented; prefer PlanBaseAwrd::read_range_to_parquet + Polars scan",
        )
        .into())
    }
}
